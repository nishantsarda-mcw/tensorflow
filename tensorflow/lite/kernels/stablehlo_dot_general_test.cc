...
//            StablehloPrecisionConfig_DEFAULT}  // precision config;
//   };
//   StablehloDotGeneralOpModel model({TensorType_INT8, {1, 3, 4}, 0, 0, 1.4,
//   0},
//                                    {TensorType_INT8, {1, 4, 3}, 0, 0, 1.2,
//                                    0}, {TensorType_INT8, {}, 0, 0, 1.2, 0},
//                                    params);

//   model.QuantizeAndPopulate<int8_t>(model.lhs(),
//                                      {2, 0, 0, 0, 5, -3, 0, 4, -1, 0, 0,
//                                      -1});
//   model.QuantizeAndPopulate<int8_t>(model.rhs(),
//                                      {0, 4, 2, 3, 3, 3, -6, -2, 1, -1, 1,
//                                      0});
...
// TEST(StablehloDotGeneralModelTest, QuantizedTestWorks3_temp) {
//   TfLiteStablehloDotGeneralParams params = {
//       {0},     // lhs_batching_dimensions;
//       1,       // num_lhs_batching_dimensions
//       {0},     // rhs_batching_dimensions;
...
//   StablehloDotGeneralOpModel model({TensorType_INT8, {1, 3, 4}, 0, 0, 1.4,
//   0},
//                                    {TensorType_INT8, {1, 4, 3}, 0, 0, 1.5,
//                                    0}, {TensorType_INT8, {}, 0, 0, 1.5, 0},
//                                    params);
...
//                                         6.6,  7.2,  8.4,  9.6};
//   EXPECT_THAT(model.GetOutput<float>(), Pointwise(FloatEq(),
//   expected_values));
// }
...
//       {-2.10215521, -1.803730,
//       -7.83739519, 4.36787844, 1.4788357, 3.10357666,
