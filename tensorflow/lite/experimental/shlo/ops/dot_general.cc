...
absl::Status CheckParameters(
  ...
  const int64_t* rhsc = rhs_contracting_dimensions.GetDataAs<DataType::kSI64>();
...
absl::Status EvaluateImpl(DotGeneralOp& op, const Tensor& lhs,
  ...
  const int64_t* lhs_batching_dimensions_data =
      lhs_batching_dimensions.GetDataAs<DataType::kSI64>();
  const int64_t* rhs_batching_dimensions_data =
      rhs_batching_dimensions.GetDataAs<DataType::kSI64>();
  const int64_t* lhs_contracting_dimensions_data =
      lhs_contracting_dimensions.GetDataAs<DataType::kSI64>();
  const int64_t* rhs_contracting_dimensions_data =
      rhs_contracting_dimensions.GetDataAs<DataType::kSI64>();
  const DimensionSize lhsb_size = lhs_batching_dimensions.NumElements();
  const DimensionSize lhsc_size = lhs_contracting_dimensions.NumElements();
  const DimensionSize rhsb_size = rhs_batching_dimensions.NumElements();
  const DimensionSize rhsc_size = rhs_contracting_dimensions.NumElements();
...
absl::Status Prepare(DotGeneralOp& op, const Tensor& lhs, const Tensor& rhs,
  ...
  const int64_t* rhs_batching_dimensions_data =
      op.attributes.rhs_batching_dimensions.GetDataAs<DataType::kSI64>();
  const int64_t* lhs_contracting_dimensions_data =
      op.attributes.lhs_contracting_dimensions.GetDataAs<DataType::kSI64>();
  const int64_t* rhs_contracting_dimensions_data =
      op.attributes.rhs_contracting_dimensions.GetDataAs<DataType::kSI64>();
